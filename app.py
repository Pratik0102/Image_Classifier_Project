# main heart of the application of the project
# in this py file - we have controlling fun like saving images,clicking next image,predicting,training etc, and GUI
"""""
import tkinter as tk                            #for GUI
from tkinter import simpledialog                #to ask initial 2 qns,of how to name the classes
import cv2 as cv
import os                                        #to handle file operations like saving and all
import PIL.Image, PIL.ImageTk                   #PIL=Python Image library- image processing pckg for py-tools like saving,creating,editing images or files
import model
import camera
...
class App:
    ...
    def __init__(self,window=tk.Tk(),window_title="Camera Classifier"):
        ...
        self.window=window                      #create a window for the user to communicate
        self.window_title=window_title          #title of the window is set

        self.counters= [1,1]                    #counter to count the no of images captured every time in [x,y] x=for class 1 images count  y=class 2 images count

        self.model = model.Model()

        self.auto_predict= False                #false means auto_prediction is now off
        ...
        self.delay= 15
        self.update()                         #updates the frames all the time
        ...
        for folder in ['1', '2']:
            for file in os.listdir(folder):
                ...
                if os.path.isfile(file_path):
                    os.unlink(file_path)            #delete the images as we have reset the class
